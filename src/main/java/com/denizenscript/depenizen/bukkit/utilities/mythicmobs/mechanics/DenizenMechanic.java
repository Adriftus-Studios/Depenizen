...
public class DenizenMechanic extends SkillMechanic implements INoTargetSkill, ITargetedLocationSkill, ITargetedEntitySkill {
    ...
    public DenizenMechanic(String name, MythicLineConfig config) {
        super(name, config);
